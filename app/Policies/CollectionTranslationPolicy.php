...
class CollectionTranslationPolicy
{
     ...
     */
    public function restore(User $user, CollectionTranslation $collectionTranslation): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, CollectionTranslation $collectionTranslation): bool
    {
        return false;
    }
}
